...
namespace AudioStream
{
    ...
    public class AudioSourceOutputDevice : MonoBehaviour
    {
        ...
        public List<string> AvailableOutputs()
        {
            ...
            AudioStreamSupport.ERRCHECK(result, this.logLevel, this.gameObjectName, null, "system.getNumDrivers");
            ...
            for (int i = 0; i < numDrivers; ++i)
            {
                ...
                AudioStreamSupport.ERRCHECK(result, this.logLevel, this.gameObjectName, null, "system.getDriverInfo");

                availableDriversNames.Add(name.ToString());

                AudioStreamSupport.LOG(LogLevel.DEBUG, this.logLevel, this.gameObjectName, null, "{0}{1}guid: {2}{3}systemrate: {4}{5}speaker mode: {6}{7}channels: {8}"
                    , name
