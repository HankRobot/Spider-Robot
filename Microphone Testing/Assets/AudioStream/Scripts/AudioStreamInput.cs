...
namespace AudioStream
{
    ...
    public class AudioStreamInput : MonoBehaviour
    {
        ...
        IEnumerator Start()
        {
            ...
            // create (temporary) fmod system just for enumerating available output drivers
            // will be recreated once actual Record is called
            ...
            */
            result = system.init(8, FMOD.INITFLAGS.NORMAL, System.IntPtr.Zero);
        ...
        const int loopingBufferSamplesCount = 65;
        IEnumerator RecordCR()
        {
            ...
            asource.clip = AudioClip.Create("Device " + this.recordDeviceId + " input", loopingBufferSamplesCount, recChannels, recRate, true, this.PCMReaderCallback);
            asource.loop = true;
        ...
        {
            if (this.isRecording && !this.isPaused && sound != null)
            {
