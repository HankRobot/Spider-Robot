...
// ( unfortunately custom editor works only for each concrete class - so it can't be used for the base abstract class )
...
[CustomEditor(typeof(AudioStream.AudioStreamMinimal))]
[CanEditMultipleObjects]
public class AudioStreamMinimalEditor : Editor
{
